...
class AcquireShareRequest(typing.TypedDict, total=False):
    capacityGb: int
    requestId: str

@typing.type_check_only
class AcquireShareResponse(typing.TypedDict, total=False):
    ipAddress: str
    shareId: str
...
@typing.type_check_only
class ListSharesResponse(typing.TypedDict, total=False):
    nextPageToken: str
    shares: _list[Share]
    unreachable: _list[str]
...
@typing.type_check_only
class ReleaseShareResponse(typing.TypedDict, total=False): ...
