...
@typing.type_check_only
class CheckInRequest(typing.TypedDict, total=False):
...
@typing.type_check_only
class CheckInResponse(typing.TypedDict, total=False):
    deadline: str
...
@typing.type_check_only
class DiskStatus(typing.TypedDict, total=False):
    freeSpaceBytes: str
    totalSpaceBytes: str
...
@typing.type_check_only
class TimestampedEvent(typing.TypedDict, total=False):
...
@typing.type_check_only
class WorkerStatus(typing.TypedDict, total=False):
