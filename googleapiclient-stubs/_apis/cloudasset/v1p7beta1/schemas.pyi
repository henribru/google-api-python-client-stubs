...
@typing.type_check_only
class GoogleCloudAssetV1p7beta1BigQueryDestination(typing.TypedDict, total=False):
    dataset: str
    force: bool
...
@typing.type_check_only
class GoogleCloudAssetV1p7beta1ExportAssetsRequest(typing.TypedDict, total=False):
...
@typing.type_check_only
class GoogleCloudAssetV1p7beta1GcsDestination(typing.TypedDict, total=False):
    uri: str
    uriPrefix: str

@typing.type_check_only
class GoogleCloudAssetV1p7beta1OutputConfig(typing.TypedDict, total=False):
    bigqueryDestination: GoogleCloudAssetV1p7beta1BigQueryDestination
    gcsDestination: GoogleCloudAssetV1p7beta1GcsDestination

@typing.type_check_only
class GoogleCloudAssetV1p7beta1PartitionSpec(typing.TypedDict, total=False):
