    ...
    class IamResource(googleapiclient.discovery.Resource):
        def troubleshoot(
            ...
            **kwargs: typing.Any,
            ...
            GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponseHttpRequest
        ): ...
...
@typing.type_check_only
class GoogleCloudPolicytroubleshooterIamV3TroubleshootIamPolicyResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
