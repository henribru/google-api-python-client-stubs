...
class DfareportingResource(googleapiclient.discovery.Resource):
    ...
    class AdsResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            ...
            | None = ...,
            creativeIds: str | _list[str] | None = ...,
            creativeOptimizationConfigurationIds: str | _list[str] | None = ...,
            dynamicClickTracker: bool | None = ...,
            ids: str | _list[str] | None = ...,
            landingPageIds: str | _list[str] | None = ...,
            maxResults: int | None = ...,
    ...
    @typing.type_check_only
    class AdvertiserInvoicesResource(googleapiclient.discovery.Resource):
        def list(
            self,
            *,
            profileId: str,
            ...
            pageToken: str | None = ...,
            **kwargs: typing.Any,
        ) -> AdvertiserInvoicesListResponseHttpRequest: ...
        def list_next(
            self,
            previous_request: AdvertiserInvoicesListResponseHttpRequest,
            previous_response: AdvertiserInvoicesListResponse,
        ) -> AdvertiserInvoicesListResponseHttpRequest | None: ...
    ...
    class AdvertisersResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            profileId: str,
            advertiserGroupIds: str | _list[str] | None = ...,
            floodlightConfigurationIds: str | _list[str] | None = ...,
            ids: str | _list[str] | None = ...,
            includeAdvertisersWithoutGroupsOnly: bool | None = ...,
            maxResults: int | None = ...,
    ...
    @typing.type_check_only
    class BillingAssignmentsResource(googleapiclient.discovery.Resource):
        def insert(
            self,
            *,
            profileId: str,
        ...
        def list(
            self, *, profileId: str, billingProfileId: str, **kwargs: typing.Any
        ) -> BillingAssignmentsListResponseHttpRequest: ...

    @typing.type_check_only
    class BillingProfilesResource(googleapiclient.discovery.Resource):
        def get(
            self, *, profileId: str, id: str, **kwargs: typing.Any
        ...
        def list_next(
            self,
            previous_request: BillingProfilesListResponseHttpRequest,
    ...
    @typing.type_check_only
    class BillingRatesResource(googleapiclient.discovery.Resource):
        def list(
            self, *, profileId: str, billingProfileId: str, **kwargs: typing.Any
        ) -> BillingRatesListResponseHttpRequest: ...
    ...
    class CampaignsResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            ...
            advertiserIds: str | _list[str] | None = ...,
            archived: bool | None = ...,
            atLeastOneOptimizationActivity: bool | None = ...,
            excludedIds: str | _list[str] | None = ...,
            ids: str | _list[str] | None = ...,
            maxResults: int | None = ...,
            overriddenEventTagId: str | None = ...,
            pageToken: str | None = ...,
    ...
    class ChangeLogsResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            ...
            pageToken: str | None = ...,
            searchString: str | None = ...,
            userProfileIds: str | _list[str] | None = ...,
            **kwargs: typing.Any,
    ...
    class CitiesResource(googleapiclient.discovery.Resource):
        def list(
            ...
            *,
            profileId: str,
            countryDartIds: str | _list[str] | None = ...,
            dartIds: str | _list[str] | None = ...,
            namePrefix: str | None = ...,
            regionDartIds: str | _list[str] | None = ...,
            **kwargs: typing.Any,
    ...
    class CreativesResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            ...
            archived: bool | None = ...,
            campaignId: str | None = ...,
            companionCreativeIds: str | _list[str] | None = ...,
            creativeFieldIds: str | _list[str] | None = ...,
            ids: str | _list[str] | None = ...,
            maxResults: int | None = ...,
            pageToken: str | None = ...,
    ...
    class DirectorySitesResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            profileId: str,
            acceptsInStreamVideoPlacements: bool | None = ...,
            acceptsInterstitialPlacements: bool | None = ...,
            acceptsPublisherPaidPlacements: bool | None = ...,
            active: bool | None = ...,
            dfpNetworkCode: str | None = ...,
            ids: str | _list[str] | None = ...,
            maxResults: int | None = ...,
            pageToken: str | None = ...,
            searchString: str | None = ...,
    ...
    class PlacementGroupsResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            ...
            advertiserIds: str | _list[str] | None = ...,
            campaignIds: str | _list[str] | None = ...,
            contentCategoryIds: str | _list[str] | None = ...,
            directorySiteIds: str | _list[str] | None = ...,
            ids: str | _list[str] | None = ...,
            maxEndDate: str | None = ...,
            maxResults: int | None = ...,
            maxStartDate: str | None = ...,
            minEndDate: str | None = ...,
    ...
    class PlacementsResource(googleapiclient.discovery.Resource):
        def generatetags(
            ...
            *,
            ...
            | None = ...,
            tagProperties_dcDbmMacroIncluded: bool | None = ...,
            tagProperties_gppMacrosIncluded: bool | None = ...,
            tagProperties_tcfGdprMacrosIncluded: bool | None = ...,
            **kwargs: typing.Any,
    ...
    def advertiserInvoices(self) -> AdvertiserInvoicesResource: ...
    def advertiserLandingPages(self) -> AdvertiserLandingPagesResource: ...
    def advertisers(self) -> AdvertisersResource: ...
    def billingAssignments(self) -> BillingAssignmentsResource: ...
    def billingProfiles(self) -> BillingProfilesResource: ...
    def billingRates(self) -> BillingRatesResource: ...
...
@typing.type_check_only
class AdvertiserInvoicesListResponseHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
...
@typing.type_check_only
class BillingAssignmentHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
...
@typing.type_check_only
class BillingAssignmentsListResponseHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
...
@typing.type_check_only
class BillingProfileHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
...
@typing.type_check_only
class BillingProfilesListResponseHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
...
@typing.type_check_only
class BillingRatesListResponseHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
