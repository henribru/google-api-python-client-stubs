...
@typing.type_check_only
class CampaignManagerIds(typing.TypedDict, total=False):
    adId: str
    campaignId: str
    creativeId: str
    kind: str
...
@typing.type_check_only
class ChannelGroupingRule(typing.TypedDict, total=False):
...
@typing.type_check_only
class CustomEvent(typing.TypedDict, total=False):
    ...
    eventType: typing.Literal["UNKNOWN", "INSERT", "ANNOTATE"]
    floodlightConfigurationId: str
...
@typing.type_check_only
class CustomEventClickAnnotation(typing.TypedDict, total=False):
    gclid: str
    kind: str

@typing.type_check_only
class CustomEventError(typing.TypedDict, total=False):
    code: typing.Literal[
...
@typing.type_check_only
class CustomEventImpressionAnnotation(typing.TypedDict, total=False):
    kind: str
    pathImpressionId: str

@typing.type_check_only
class CustomEventInsert(typing.TypedDict, total=False):
    cmDimensions: CampaignManagerIds
    dv3Dimensions: DV3Ids
    insertEventType: typing.Literal["UNKNOWN", "IMPRESSION", "CLICK"]
    kind: str
    matchId: str
    mobileDeviceId: str

@typing.type_check_only
class CustomEventStatus(typing.TypedDict, total=False):
    customEvent: CustomEvent
    errors: _list[CustomEventError]
    kind: str

@typing.type_check_only
class CustomEventsBatchInsertRequest(typing.TypedDict, total=False):
    customEvents: _list[CustomEvent]
    kind: str

@typing.type_check_only
class CustomEventsBatchInsertResponse(typing.TypedDict, total=False):
    hasFailures: bool
    kind: str
    status: _list[CustomEventStatus]
...
@typing.type_check_only
class DV3Ids(typing.TypedDict, total=False):
    dvCampaignId: str
    dvCreativeId: str
...
class PathFilter(typing.TypedDict, total=False):
    eventFilters: _list[EventFilter]
    kind: str
    pathMatchPosition: typing.Literal[
        "PATH_MATCH_POSITION_UNSPECIFIED", "ANY", "FIRST", "LAST"
    ]

@typing.type_check_only
class PathReportCompatibleFields(typing.TypedDict, total=False):
...
@typing.type_check_only
class PathReportDimensionValue(typing.TypedDict, total=False):
    dimensionName: str
    ids: _list[str]
    kind: str
    matchType: typing.Literal["EXACT", "BEGINS_WITH", "CONTAINS", "WILDCARD_EXPRESSION"]
...
class UniversalAdId(typing.TypedDict, total=False):
    registry: typing.Literal["OTHER", "AD_ID_OFFICIAL", "CLEARCAST", "DCM"]
    value: str
