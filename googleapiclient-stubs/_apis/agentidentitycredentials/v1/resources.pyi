            ...
            class AuthProvidersResource(googleapiclient.discovery.Resource):
                ...
                class CredentialsResource(googleapiclient.discovery.Resource):
                    def finalize(
                        ...
                        *,
                        authProvider: str,
                        body: GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsRequest,
                        **kwargs: typing.Any,
                    ) -> GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponseHttpRequest: ...
                    def retrieve(
                        self,
                        *,
                        authProvider: str,
                        ...
                        **kwargs: typing.Any,
                    ) -> GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponseHttpRequest: ...
...
@typing.type_check_only
class GoogleCloudAgentidentitycredentialsV1_FinalizeCredentialsResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudAgentidentitycredentialsV1_RetrieveCredentialsResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
