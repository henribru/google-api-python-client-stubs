...
@typing.type_check_only
class AntivirusInfo(typing.TypedDict, total=False):
    displayName: str
    productGuid: str
    productState: typing.Literal[
...
@typing.type_check_only
class ApproveDeviceUserRequest(typing.TypedDict, total=False):
    customer: str

@typing.type_check_only
class ApproveDeviceUserResponse(typing.TypedDict, total=False):
    deviceUser: DeviceUser

@typing.type_check_only
class BlockDeviceUserRequest(typing.TypedDict, total=False):
    customer: str

@typing.type_check_only
class BlockDeviceUserResponse(typing.TypedDict, total=False):
    deviceUser: DeviceUser

@typing.type_check_only
class BrowserAttributes(typing.TypedDict, total=False):
    chromeBrowserInfo: BrowserInfo
    chromeProfileId: str
    lastProfileSyncTime: str

@typing.type_check_only
class BrowserInfo(typing.TypedDict, total=False):
...
@typing.type_check_only
class CancelWipeDeviceRequest(typing.TypedDict, total=False):
    customer: str

@typing.type_check_only
class CancelWipeDeviceResponse(typing.TypedDict, total=False):
    device: Device

@typing.type_check_only
class CancelWipeDeviceUserRequest(typing.TypedDict, total=False):
    customer: str

@typing.type_check_only
class CancelWipeDeviceUserResponse(typing.TypedDict, total=False):
    deviceUser: DeviceUser

@typing.type_check_only
class CertificateAttributes(typing.TypedDict, total=False):
...
@typing.type_check_only
class ChromePolicy(typing.TypedDict, total=False):
    conflicts: _list[PolicyConflict]
    name: str
    scope: typing.Literal["SCOPE_UNKNOWN", "USER", "MACHINE"]
...
@typing.type_check_only
class ClientState(typing.TypedDict, total=False):
    assetTags: _list[str]
...
@typing.type_check_only
class CreateDeviceRequest(typing.TypedDict, total=False):
    customer: str
    device: Device
...
@typing.type_check_only
class CustomAttributeValue(typing.TypedDict, total=False):
    boolValue: bool
    numberValue: float
    stringValue: str
...
class Device(typing.TypedDict, total=False):
    ...
    name: str
    networkOperator: str
    osFirewallStatus: typing.Literal[
...
@typing.type_check_only
class DeviceUser(typing.TypedDict, total=False):
    compromisedState: typing.Literal[
...
@typing.type_check_only
class EndpointVerificationSpecificAttributes(typing.TypedDict, total=False):
...
@typing.type_check_only
class ListDeviceUsersResponse(typing.TypedDict, total=False):
...
@typing.type_check_only
class ListOrgMembershipsResponse(typing.TypedDict, total=False):
    nextPageToken: str
...
@typing.type_check_only
class LookupSelfDeviceUsersResponse(typing.TypedDict, total=False):
    customer: str
    names: _list[str]
    nextPageToken: str
...
@typing.type_check_only
class MoveOrgMembershipRequest(typing.TypedDict, total=False):
    customer: str
...
@typing.type_check_only
class OrgMembership(typing.TypedDict, total=False):
    member: str
    memberUri: str
    name: str
    type: typing.Literal["ENTITY_TYPE_UNSPECIFIED", "SHARED_DRIVE"]
...
@typing.type_check_only
class PolicyConflict(typing.TypedDict, total=False):
    scope: typing.Literal["SCOPE_UNKNOWN", "USER", "MACHINE"]
    source: typing.Literal[
        "SOURCE_UNKNOWN",
        "ENTERPRISE_DEFAULT",
...
@typing.type_check_only
class PosixGroup(typing.TypedDict, total=False):
    gid: str
    name: str
    systemId: str
...
@typing.type_check_only
class WindowsSpecificDeviceAttributes(typing.TypedDict, total=False):
    hotfixes: _list[str]
...
@typing.type_check_only
class WipeDeviceRequest(typing.TypedDict, total=False):
    customer: str
    removeResetLock: bool

@typing.type_check_only
class WipeDeviceResponse(typing.TypedDict, total=False):
    device: Device

@typing.type_check_only
class WipeDeviceUserRequest(typing.TypedDict, total=False):
    customer: str

@typing.type_check_only
class WipeDeviceUserResponse(typing.TypedDict, total=False):
    deviceUser: DeviceUser
