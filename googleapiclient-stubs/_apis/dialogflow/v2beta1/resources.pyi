...
class DialogflowResource(googleapiclient.discovery.Resource):
    ...
    class ProjectsResource(googleapiclient.discovery.Resource):
                ...
                class DocumentsResource(googleapiclient.discovery.Resource):
                    def create(
                        ...
                        *,
                        ...
                        importGcsCustomMetadata: bool | None = ...,
                        **kwargs: typing.Any,
                    ) -> GoogleLongrunningOperationHttpRequest: ...
                    def delete(
                        self, *, name: str, **kwargs: typing.Any
            ...
            class ParticipantsResource(googleapiclient.discovery.Resource):
                ...
                class SuggestionsResource(googleapiclient.discovery.Resource):
                    ...
                    def suggestKnowledgeAssist(
                        ...
                        **kwargs: typing.Any,
                    ) -> GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponseHttpRequest: ...
            ...
            class SuggestionsResource(googleapiclient.discovery.Resource):
                def generate(
                    ...
                    **kwargs: typing.Any,
                    ...
                    GoogleCloudDialogflowV2beta1GenerateSuggestionsResponseHttpRequest
                ): ...
                def searchKnowledge(
                    self,
                    *,
        ...
        class GeneratorsResource(googleapiclient.discovery.Resource):
            ...
            def list_next(
                self,
                previous_request: GoogleCloudDialogflowV2beta1ListGeneratorsResponseHttpRequest,
                previous_response: GoogleCloudDialogflowV2beta1ListGeneratorsResponse,
            ) -> (
                GoogleCloudDialogflowV2beta1ListGeneratorsResponseHttpRequest | None
            ): ...
        ...
        class LocationsResource(googleapiclient.discovery.Resource):
            ...
            class ConversationsResource(googleapiclient.discovery.Resource):
                ...
                def ingestContextReferences(
                    ...
                    **kwargs: typing.Any,
                ) -> GoogleCloudDialogflowV2beta1IngestContextReferencesResponseHttpRequest: ...
                def list(
                    self,
                    *,
                    parent: str,
            ...
            @typing.type_check_only
            class PhoneNumbersResource(googleapiclient.discovery.Resource):
                def delete(
                    self, *, name: str, **kwargs: typing.Any
                ) -> GoogleCloudDialogflowV2beta1PhoneNumberHttpRequest: ...
                def list(
                    self,
                    *,
                    parent: str,
                    ...
                    **kwargs: typing.Any,
                    ...
                    GoogleCloudDialogflowV2beta1ListPhoneNumbersResponseHttpRequest
                ): ...
                def list_next(
                    self,
                    previous_request: GoogleCloudDialogflowV2beta1ListPhoneNumbersResponseHttpRequest,
                    previous_response: GoogleCloudDialogflowV2beta1ListPhoneNumbersResponse,
                ) -> (
                    GoogleCloudDialogflowV2beta1ListPhoneNumbersResponseHttpRequest
                    | None
                ): ...
            ...
            class SipTrunksResource(googleapiclient.discovery.Resource):
                def create(
                    ...
                    **kwargs: typing.Any,
                ) -> GoogleCloudDialogflowV2beta1SipTrunkHttpRequest: ...
                def delete(
                    self, *, name: str, **kwargs: typing.Any
                ) -> GoogleProtobufEmptyHttpRequest: ...
                def get(
                ...
                def list_next(
                    self,
                    previous_request: GoogleCloudDialogflowV2beta1ListSipTrunksResponseHttpRequest,
                    previous_response: GoogleCloudDialogflowV2beta1ListSipTrunksResponse,
                ) -> (
                    GoogleCloudDialogflowV2beta1ListSipTrunksResponseHttpRequest | None
                ): ...
                def patch(
                    self,
                    *,
            ...
            class StatelessSuggestionResource(googleapiclient.discovery.Resource):
                def generate(
                    ...
                    **kwargs: typing.Any,
                ) -> GoogleCloudDialogflowV2beta1GenerateStatelessSuggestionResponseHttpRequest: ...
            ...
            def getEncryptionSpec(
                self, *, name: str, **kwargs: typing.Any
            ) -> GoogleCloudDialogflowV2beta1EncryptionSpecHttpRequest: ...
            def list(
                self,
                *,
                name: str,
        ...
        class PhoneNumbersResource(googleapiclient.discovery.Resource):
            ...
            def list_next(
                ...
                GoogleCloudDialogflowV2beta1ListPhoneNumbersResponseHttpRequest | None
            ): ...
            def patch(
                self,
                *,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1EncryptionSpecHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1GenerateStatelessSuggestionResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1GenerateSuggestionsResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1GeneratorHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1ListPhoneNumbersResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1ListSipTrunksResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1PhoneNumberHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1SipTrunkHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
...
@typing.type_check_only
class GoogleCloudDialogflowV2beta1SuggestKnowledgeAssistResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
