...
class DirectoryResource(googleapiclient.discovery.Resource):
    ...
    class ChromeosdevicesResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            customerId: str,
            includeChildOrgunits: bool | None = ...,
            maxResults: int | None = ...,
    ...
    class GroupsResource(googleapiclient.discovery.Resource):
        ...
        def insert(self, *, body: Group, **kwargs: typing.Any) -> GroupHttpRequest: ...
        def list(
            self,
            *,
            customer: str | None = ...,
            domain: str | None = ...,
            maxResults: int | None = ...,
            orderBy: typing.Literal["email"] | None = ...,
            pageToken: str | None = ...,
            query: str | None = ...,
            sortOrder: typing.Literal["ASCENDING", "DESCENDING"] | None = ...,
            userKey: str | None = ...,
    ...
    class MembersResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            groupKey: str,
            includeDerivedMembership: bool | None = ...,
            maxResults: int | None = ...,
            pageToken: str | None = ...,
            roles: str | None = ...,
            **kwargs: typing.Any,
        ...
        def patch(
            self, *, groupKey: str, memberKey: str, body: Member, **kwargs: typing.Any
        ) -> MemberHttpRequest: ...
        def update(
            self, *, groupKey: str, memberKey: str, body: Member, **kwargs: typing.Any
        ) -> MemberHttpRequest: ...
    ...
    class OrgunitsResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            customerId: str,
            orgUnitPath: str | None = ...,
            type: typing.Literal["all", "children", "allIncludingParent"] | None = ...,
            **kwargs: typing.Any,
        ) -> OrgUnitsHttpRequest: ...
        def patch(
            self,
    ...
    class ResourcesResource(googleapiclient.discovery.Resource):
        ...
        class BuildingsResource(googleapiclient.discovery.Resource):
            ...
            def insert(
                ...
                *,
                customer: str,
                body: Building,
                coordinatesSource: typing.Literal[
        ...
        class CalendarsResource(googleapiclient.discovery.Resource):
            ...
            def insert(
                self, *, customer: str, body: CalendarResource, **kwargs: typing.Any
            ) -> CalendarResourceHttpRequest: ...
            def list(
                self,
                *,
    ...
    class RoleAssignmentsResource(googleapiclient.discovery.Resource):
        ...
        def list(
            ...
            *,
            customer: str,
            includeIndirectRoleAssignments: bool | None = ...,
            maxResults: int | None = ...,
            pageToken: str | None = ...,
            roleId: str | None = ...,
            userKey: str | None = ...,
    ...
    class SchemasResource(googleapiclient.discovery.Resource):
        ...
        def patch(
            self, *, customerId: str, schemaKey: str, body: Schema, **kwargs: typing.Any
        ) -> SchemaHttpRequest: ...
        def update(
            self, *, customerId: str, schemaKey: str, body: Schema, **kwargs: typing.Any
        ) -> SchemaHttpRequest: ...
    ...
    class UsersResource(googleapiclient.discovery.Resource):
        ...
        class AliasesResource(googleapiclient.discovery.Resource):
            ...
            def list(
                ...
                *,
                userKey: str,
                event: typing.Literal["add", "delete"] | None = ...,
                **kwargs: typing.Any,
            ) -> AliasesHttpRequest: ...
            def watch(
                self,
        ...
        def get(
            ...
            *,
            userKey: str,
            customFieldMask: str | None = ...,
            projection: typing.Literal["basic", "custom", "full"] | None = ...,
            viewType: typing.Literal["admin_view", "domain_public"] | None = ...,
            **kwargs: typing.Any,
        ) -> UserHttpRequest: ...
        def insert(
            self,
            *,
            body: User,
            resolveConflictAccount: bool | None = ...,
            **kwargs: typing.Any,
        ) -> UserHttpRequest: ...
        def list(
            self,
            *,
            ...
            customer: str | None = ...,
            domain: str | None = ...,
            event: typing.Literal["add", "delete", "makeAdmin", "undelete", "update"]
            | None = ...,
            maxResults: int | None = ...,
            orderBy: typing.Literal["email", "familyName", "givenName"] | None = ...,
            pageToken: str | None = ...,
            projection: typing.Literal["basic", "custom", "full"] | None = ...,
            query: str | None = ...,
            showDeleted: str | None = ...,
            sortOrder: typing.Literal["ASCENDING", "DESCENDING"] | None = ...,
            viewType: typing.Literal["admin_view", "domain_public"] | None = ...,
            **kwargs: typing.Any,
        ) -> UsersHttpRequest: ...
