    ...
    class LocationsResource(googleapiclient.discovery.Resource):
            ...
            class ImpressionsResource(googleapiclient.discovery.Resource):
                ...
                class MonthlyResource(googleapiclient.discovery.Resource):
                    def list(
                        ...
                        *,
                        parent: str,
                        monthlyRange_endMonth_day: int | None = ...,
                        monthlyRange_endMonth_month: int | None = ...,
                        monthlyRange_endMonth_year: int | None = ...,
                        monthlyRange_startMonth_day: int | None = ...,
                        monthlyRange_startMonth_month: int | None = ...,
                        monthlyRange_startMonth_year: int | None = ...,
                        pageSize: int | None = ...,
                        pageToken: str | None = ...,
                        **kwargs: typing.Any,
        ...
        def fetchMultiDailyMetricsTimeSeries(
            ...
            *,
            ...
            | None = ...,
            dailyRange_endDate_day: int | None = ...,
            dailyRange_endDate_month: int | None = ...,
            dailyRange_endDate_year: int | None = ...,
        ...
        def getDailyMetricsTimeSeries(
            ...
            *,
            ...
            | None = ...,
            dailySubEntityType_timeOfDay_hours: int | None = ...,
            dailySubEntityType_timeOfDay_minutes: int | None = ...,
            dailySubEntityType_timeOfDay_nanos: int | None = ...,
            dailySubEntityType_timeOfDay_seconds: int | None = ...,
            **kwargs: typing.Any,
