        ...
        class LocationsResource(googleapiclient.discovery.Resource):
            ...
            class GlobalResource(googleapiclient.discovery.Resource):
                ...
                class PolicyOrchestratorsResource(googleapiclient.discovery.Resource):
                    ...
                    ) -> GoogleCloudOsconfigV2__PolicyOrchestratorHttpRequest: ...
                    def list(
                        self,
                        *,
                        parent: str,
                    ...
                    def list_next(
                        self,
                        previous_request: GoogleCloudOsconfigV2__ListPolicyOrchestratorsResponseHttpRequest,
                        previous_response: GoogleCloudOsconfigV2__ListPolicyOrchestratorsResponse,
                    ) -> (
                        GoogleCloudOsconfigV2__ListPolicyOrchestratorsResponseHttpRequest
                        | None
                    ): ...
...
@typing.type_check_only
class GoogleCloudOsconfigV2__ListPolicyOrchestratorsResponseHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudOsconfigV2__PolicyOrchestratorHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
