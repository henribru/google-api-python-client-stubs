...
@typing.type_check_only
class GoogleCloudOsconfigV2_OrchestrationScope_LocationSelector(
    typing.TypedDict, total=False
):
    includedLocations: _list[str]

@typing.type_check_only
class GoogleCloudOsconfigV2_OrchestrationScope_ResourceHierarchySelector(
    typing.TypedDict, total=False
):
...
@typing.type_check_only
class GoogleCloudOsconfigV2_OrchestrationScope_Selector(typing.TypedDict, total=False):
...
@typing.type_check_only
class GoogleCloudOsconfigV2_PolicyOrchestrator_IterationState(
    typing.TypedDict, total=False
):
    error: Status
    failedActions: str
...
@typing.type_check_only
class GoogleCloudOsconfigV2_PolicyOrchestrator_OrchestrationState(
    typing.TypedDict, total=False
):
...
@typing.type_check_only
class GoogleCloudOsconfigV2__ListPolicyOrchestratorsResponse(
    typing.TypedDict, total=False
):
    nextPageToken: str
    policyOrchestrators: _list[GoogleCloudOsconfigV2__PolicyOrchestrator]
...
@typing.type_check_only
class GoogleCloudOsconfigV2__OrchestratedResource(typing.TypedDict, total=False):
    id: str
    osPolicyAssignmentV1Payload: OSPolicyAssignment

@typing.type_check_only
class GoogleCloudOsconfigV2__OrchestrationScope(typing.TypedDict, total=False):
    selectors: _list[GoogleCloudOsconfigV2_OrchestrationScope_Selector]

@typing.type_check_only
class GoogleCloudOsconfigV2__PolicyOrchestrator(typing.TypedDict, total=False):
    action: str
    createTime: str
    description: str
    etag: str
