...
@typing.type_check_only
class GoogleCloudFunctionsV2betaLocationMetadata(typing.TypedDict, total=False):
    environments: _list[typing.Literal["ENVIRONMENT_UNSPECIFIED", "GEN_1", "GEN_2"]]

@typing.type_check_only
class GoogleCloudFunctionsV2betaOperationMetadata(typing.TypedDict, total=False):
    apiVersion: str
    buildName: str
...
@typing.type_check_only
class GoogleCloudFunctionsV2betaStage(typing.TypedDict, total=False):
    message: str
    name: typing.Literal[
        "NAME_UNSPECIFIED",
        "ARTIFACT_REGISTRY",
...
@typing.type_check_only
class GoogleCloudFunctionsV2betaStateMessage(typing.TypedDict, total=False):
    message: str
