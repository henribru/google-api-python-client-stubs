...
@typing.type_check_only
class GoogleCloudFunctionsV2LocationMetadata(typing.TypedDict, total=False):
    environments: _list[typing.Literal["ENVIRONMENT_UNSPECIFIED", "GEN_1", "GEN_2"]]

@typing.type_check_only
class GoogleCloudFunctionsV2OperationMetadata(typing.TypedDict, total=False):
    apiVersion: str
    buildName: str
...
@typing.type_check_only
class GoogleCloudFunctionsV2Stage(typing.TypedDict, total=False):
    message: str
    name: typing.Literal[
        "NAME_UNSPECIFIED",
        "ARTIFACT_REGISTRY",
...
@typing.type_check_only
class GoogleCloudFunctionsV2StateMessage(typing.TypedDict, total=False):
    message: str
