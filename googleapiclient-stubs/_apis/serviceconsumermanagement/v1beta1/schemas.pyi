...
@typing.type_check_only
class V1Beta1ConsumerQuotaLimit(typing.TypedDict, total=False):
    isPrecise: bool
    metric: str
    name: str
...
@typing.type_check_only
class V1Beta1ConsumerQuotaMetric(typing.TypedDict, total=False):
...
@typing.type_check_only
class V1Beta1ImportProducerOverridesRequest(typing.TypedDict, total=False):
    force: bool
...
@typing.type_check_only
class V1Beta1ImportProducerQuotaPoliciesRequest(typing.TypedDict, total=False):
    force: bool
    forceJustification: str
...
@typing.type_check_only
class V1Beta1ListConsumerQuotaMetricsResponse(typing.TypedDict, total=False):
    metrics: _list[V1Beta1ConsumerQuotaMetric]
    nextPageToken: str

@typing.type_check_only
class V1Beta1ListProducerOverridesResponse(typing.TypedDict, total=False):
    nextPageToken: str
    overrides: _list[V1Beta1QuotaOverride]

@typing.type_check_only
class V1Beta1ListProducerQuotaPoliciesResponse(typing.TypedDict, total=False):
    nextPageToken: str
    producerQuotaPolicies: _list[V1Beta1ProducerQuotaPolicy]

@typing.type_check_only
class V1Beta1OverrideInlineSource(typing.TypedDict, total=False):
    overrides: _list[V1Beta1QuotaOverride]

@typing.type_check_only
class V1Beta1PolicyInlineSource(typing.TypedDict, total=False):
    policies: _list[V1Beta1ProducerQuotaPolicy]
...
@typing.type_check_only
class V1Beta1QuotaBucket(typing.TypedDict, total=False):
...
@typing.type_check_only
class V1Beta1RolloutInfo(typing.TypedDict, total=False):
...
@typing.type_check_only
class V1beta1AddVisibilityLabelsResponse(typing.TypedDict, total=False):
    labels: _list[str]

@typing.type_check_only
class V1beta1DefaultIdentity(typing.TypedDict, total=False):
    email: str
    name: str
    tag: str
    uniqueId: str
...
@typing.type_check_only
class V1beta1GenerateDefaultIdentityResponse(typing.TypedDict, total=False):
...
@typing.type_check_only
class V1beta1GenerateServiceAccountResponse(typing.TypedDict, total=False):
...
@typing.type_check_only
class V1beta1RemoveVisibilityLabelsResponse(typing.TypedDict, total=False):
    labels: _list[str]

@typing.type_check_only
class V1beta1ServiceAccount(typing.TypedDict, total=False):
    email: str
    iamAccountName: str
    name: str
    tag: str
