...
class AddTenantProjectRequest(typing.TypedDict, total=False):
...
@typing.type_check_only
class ApplyTenantProjectConfigRequest(typing.TypedDict, total=False):
    projectConfig: TenantProjectConfig
    tag: str
...
@typing.type_check_only
class AttachTenantProjectRequest(typing.TypedDict, total=False):
...
@typing.type_check_only
class CreateTenancyUnitRequest(typing.TypedDict, total=False):
    tenancyUnitId: str
...
@typing.type_check_only
class DeleteTenantProjectRequest(typing.TypedDict, total=False):
    tag: str
...
@typing.type_check_only
class ListTenancyUnitsResponse(typing.TypedDict, total=False):
    nextPageToken: str
...
@typing.type_check_only
class RemoveTenantProjectRequest(typing.TypedDict, total=False):
    tag: str
...
@typing.type_check_only
class SearchTenancyUnitsResponse(typing.TypedDict, total=False):
    nextPageToken: str
    tenancyUnits: _list[TenancyUnit]
...
@typing.type_check_only
class ServiceAccountConfig(typing.TypedDict, total=False):
    accountId: str
...
@typing.type_check_only
class TenancyUnit(typing.TypedDict, total=False):
    consumer: str
    createTime: str
    name: str
    service: str
...
@typing.type_check_only
class TenantProjectConfig(typing.TypedDict, total=False):
...
@typing.type_check_only
class TenantProjectPolicy(typing.TypedDict, total=False):
    policyBindings: _list[PolicyBinding]

@typing.type_check_only
class TenantResource(typing.TypedDict, total=False):
...
@typing.type_check_only
class UndeleteTenantProjectRequest(typing.TypedDict, total=False):
    tag: str
...
@typing.type_check_only
class V1AddVisibilityLabelsResponse(typing.TypedDict, total=False):
    labels: _list[str]

@typing.type_check_only
class V1Beta1BatchCreateProducerOverridesResponse(typing.TypedDict, total=False):
    overrides: _list[V1Beta1QuotaOverride]

@typing.type_check_only
class V1Beta1DisableConsumerResponse(typing.TypedDict, total=False): ...

@typing.type_check_only
class V1Beta1EnableConsumerResponse(typing.TypedDict, total=False): ...

@typing.type_check_only
class V1Beta1GenerateServiceIdentityResponse(typing.TypedDict, total=False):
    identity: V1Beta1ServiceIdentity

@typing.type_check_only
class V1Beta1ImportProducerOverridesResponse(typing.TypedDict, total=False):
    overrides: _list[V1Beta1QuotaOverride]

@typing.type_check_only
class V1Beta1ImportProducerQuotaPoliciesResponse(typing.TypedDict, total=False):
    policies: _list[V1Beta1ProducerQuotaPolicy]

@typing.type_check_only
class V1Beta1ProducerQuotaPolicy(typing.TypedDict, total=False):
    container: str
...
@typing.type_check_only
class V1Beta1QuotaOverride(typing.TypedDict, total=False):
...
@typing.type_check_only
class V1Beta1RefreshConsumerResponse(typing.TypedDict, total=False): ...

@typing.type_check_only
class V1Beta1ServiceIdentity(typing.TypedDict, total=False):
    email: str
    name: str
    projectRole: str
    tag: str
...
@typing.type_check_only
class V1DefaultIdentity(typing.TypedDict, total=False):
    email: str
    name: str
    tag: str
    uniqueId: str
...
@typing.type_check_only
class V1DisableConsumerResponse(typing.TypedDict, total=False): ...

@typing.type_check_only
class V1EnableConsumerResponse(typing.TypedDict, total=False): ...

@typing.type_check_only
class V1GenerateDefaultIdentityResponse(typing.TypedDict, total=False):
    attachStatus: typing.Literal[
...
@typing.type_check_only
class V1GenerateServiceAccountResponse(typing.TypedDict, total=False):
    account: V1ServiceAccount

@typing.type_check_only
class V1RefreshConsumerResponse(typing.TypedDict, total=False): ...

@typing.type_check_only
class V1RemoveVisibilityLabelsResponse(typing.TypedDict, total=False):
    labels: _list[str]

@typing.type_check_only
class V1ServiceAccount(typing.TypedDict, total=False):
    email: str
    iamAccountName: str
    name: str
    tag: str
