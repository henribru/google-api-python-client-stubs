...
@typing.type_check_only
class ContainerThreatDetectionSettings(typing.TypedDict, total=False):
    modules: dict[str, typing.Any]
    name: str
    serviceAccount: str
    serviceEnablementState: typing.Literal[
        "ENABLEMENT_STATE_UNSPECIFIED", "INHERITED", "ENABLED", "DISABLED"
    ]
    updateTime: str
...
@typing.type_check_only
class EventThreatDetectionSettings(typing.TypedDict, total=False):
    modules: dict[str, typing.Any]
    name: str
    serviceEnablementState: typing.Literal[
        "ENABLEMENT_STATE_UNSPECIFIED", "INHERITED", "ENABLED", "DISABLED"
...
@typing.type_check_only
class RapidVulnerabilityDetectionSettings(typing.TypedDict, total=False):
    modules: dict[str, typing.Any]
    name: str
    serviceEnablementState: typing.Literal[
        "ENABLEMENT_STATE_UNSPECIFIED", "INHERITED", "ENABLED", "DISABLED"
...
@typing.type_check_only
class SecurityCenterSettings(typing.TypedDict, total=False):
    cryptoKeyName: str
    logSinkProject: str
    name: str
    onboardingTime: str
...
@typing.type_check_only
class SecurityHealthAnalyticsSettings(typing.TypedDict, total=False):
    modules: dict[str, typing.Any]
    name: str
    serviceAccount: str
    serviceEnablementState: typing.Literal[
...
@typing.type_check_only
class VirtualMachineThreatDetectionSettings(typing.TypedDict, total=False):
    modules: dict[str, typing.Any]
    name: str
    serviceAccount: str
    serviceEnablementState: typing.Literal[
...
@typing.type_check_only
class WebSecurityScannerSettings(typing.TypedDict, total=False):
    modules: dict[str, typing.Any]
    name: str
    serviceEnablementState: typing.Literal[
        "ENABLEMENT_STATE_UNSPECIFIED", "INHERITED", "ENABLED", "DISABLED"
