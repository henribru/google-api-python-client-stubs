...
@typing.type_check_only
class GoogleCloudAssuredworkloadsV1Rule(typing_extensions.TypedDict, total=False):
...
@typing.type_check_only
class GoogleCloudAssuredworkloadsV1StringList(typing_extensions.TypedDict, total=False):
    values: _list[str]
...
@typing.type_check_only
class GoogleCloudAssuredworkloadsV1Trend(typing_extensions.TypedDict, total=False):
    duration: str
    valuePercent: float
