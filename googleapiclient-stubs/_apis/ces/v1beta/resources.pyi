            ...
            class AppsResource(googleapiclient.discovery.Resource):
                ...
                class EvaluationExpectationsResource(
                    ...
                    def create(
                        ...
                        *,
                        ...
                        evaluationExpectationId: str | None = ...,
                        **kwargs: typing.Any,
                ...
                class EvaluationsResource(googleapiclient.discovery.Resource):
                    ...
                    def list(
                        ...
                        *,
                        parent: str,
                        evaluationFilter: str | None = ...,
                        evaluationRunFilter: str | None = ...,
                        filter: str | None = ...,
                        lastTenResults: bool | None = ...,
                        orderBy: str | None = ...,
                        pageSize: int | None = ...,
                        pageToken: str | None = ...,
                        **kwargs: typing.Any,
                ...
                class ScheduledEvaluationRunsResource(
                    ...
                    def create(
                        ...
                        *,
                        ...
                        scheduledEvaluationRunId: str | None = ...,
                        **kwargs: typing.Any,
                ...
                def runEvaluation(
                    self, *, app: str, body: RunEvaluationRequest, **kwargs: typing.Any
                ) -> OperationHttpRequest: ...
