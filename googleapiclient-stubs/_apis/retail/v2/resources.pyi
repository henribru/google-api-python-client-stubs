        ...
        class LocationsResource(googleapiclient.discovery.Resource):
            ...
            class CatalogsResource(googleapiclient.discovery.Resource):
                ...
                class ModelsResource(googleapiclient.discovery.Resource):
                    ...
                    def get(
                        self, *, name: str, **kwargs: typing.Any
                    ) -> GoogleCloudRetailV2ModelHttpRequest: ...
                    def list(
                        self,
                        *,
                        parent: str,
                        ...
                        pageToken: str | None = ...,
                        **kwargs: typing.Any,
                    ) -> GoogleCloudRetailV2ListModelsResponseHttpRequest: ...
                    def list_next(
                        self,
                        previous_request: GoogleCloudRetailV2ListModelsResponseHttpRequest,
                        previous_response: GoogleCloudRetailV2ListModelsResponse,
                    ) -> GoogleCloudRetailV2ListModelsResponseHttpRequest | None: ...
                    def patch(
                        self,
                        *,
                        name: str,
                ...
                def completeQuery(
                    ...
                    *,
                    ...
                    dataset: str | None = ...,
                    deviceType: str | None = ...,
                    enableAttributeSuggestions: bool | None = ...,
                    entity: str | None = ...,
                ...
                def getConversationalSearchCustomizationConfig(
                    self, *, name: str, **kwargs: typing.Any
                ) -> GoogleCloudRetailV2ConversationalSearchCustomizationConfigHttpRequest: ...
...
@typing.type_check_only
class GoogleCloudRetailV2ConversationalSearchCustomizationConfigHttpRequest(
    googleapiclient.http.HttpRequest
):
    def execute(
        self,
...
@typing.type_check_only
class GoogleCloudRetailV2ModelHttpRequest(googleapiclient.http.HttpRequest):
    def execute(
        self,
        http: httplib2.Http | googleapiclient.http.HttpMock | None = None,
        num_retries: int = 0,
