...
@typing.type_check_only
class GoogleCloudVideointelligenceV1_FaceDetectionConfig(typing.TypedDict, total=False):
...
@typing.type_check_only
class GoogleCloudVideointelligenceV1_PersonDetectionConfig(
    typing.TypedDict, total=False
):
    includeAttributes: bool
    includeBoundingBoxes: bool
...
@typing.type_check_only
class GoogleCloudVideointelligenceV1_SpeechContext(typing.TypedDict, total=False):
    phrases: _list[str]
...
@typing.type_check_only
class GoogleCloudVideointelligenceV1_TextDetectionConfig(typing.TypedDict, total=False):
...
@typing.type_check_only
class GoogleCloudVideointelligenceV1_VideoContext(typing.TypedDict, total=False):
...
@typing.type_check_only
class GoogleLongrunning_CancelOperationRequest(typing.TypedDict, total=False): ...

@typing.type_check_only
class GoogleLongrunning_ListOperationsResponse(typing.TypedDict, total=False):
    nextPageToken: str
...
@typing.type_check_only
class GoogleProtobuf_Empty(typing.TypedDict, total=False): ...
