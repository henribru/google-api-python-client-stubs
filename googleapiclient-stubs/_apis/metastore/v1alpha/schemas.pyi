...
@typing.type_check_only
class CancelMigrationResponse(typing.TypedDict, total=False):
...
@typing.type_check_only
class CompleteMigrationResponse(typing.TypedDict, total=False):
    migrationExecution: str
...
@typing.type_check_only
class CustomRegionConfig(typing.TypedDict, total=False):
...
@typing.type_check_only
class Lake(typing.TypedDict, total=False):
    name: str
...
@typing.type_check_only
class MultiRegionConfig(typing.TypedDict, total=False):
...
@typing.type_check_only
class RootCACertificate(typing.TypedDict, total=False):
    certificate: str
    expirationTime: str
