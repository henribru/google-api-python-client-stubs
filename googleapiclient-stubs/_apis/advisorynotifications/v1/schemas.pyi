...
class GoogleCloudAdvisorynotificationsV1Attachment(typing.TypedDict, total=False):
    csv: GoogleCloudAdvisorynotificationsV1Csv
    displayName: str

@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1Csv(typing.TypedDict, total=False):
    dataRows: _list[GoogleCloudAdvisorynotificationsV1CsvCsvRow]
    headers: _list[str]

@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1CsvCsvRow(typing.TypedDict, total=False):
    entries: _list[str]
...
@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1Message(typing.TypedDict, total=False):
...
@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1MessageBody(typing.TypedDict, total=False):
    text: GoogleCloudAdvisorynotificationsV1Text

@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1Notification(typing.TypedDict, total=False):
    createTime: str
...
@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1Settings(typing.TypedDict, total=False):
    etag: str
    name: str
    notificationSettings: dict[str, typing.Any]

@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1Subject(typing.TypedDict, total=False):
    text: GoogleCloudAdvisorynotificationsV1Text

@typing.type_check_only
class GoogleCloudAdvisorynotificationsV1Text(typing.TypedDict, total=False):
    enText: str
    localizationState: typing.Literal[
